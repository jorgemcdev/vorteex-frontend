            ...
            <ListGroup className="list-group-accent" tag="div">
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-warning list-group-item-divider">
                <div className="avatar float-right">
                  <img className="img-avatar" src={`${avatars}/7.jpg`} alt="admin@bootstrapmaster.com" />
                </div>
                <div>
                  Meeting with
                  <strong>Lucas</strong>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-info list-group-item-divider">
                <div className="avatar float-right">
                  <img className="img-avatar" src={`${avatars}/4.jpg`} alt="admin@bootstrapmaster.com" />
                </div>
                <div>
                  Skype with
                  <strong>Megan</strong>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-danger list-group-item-divider">
                ...
                <div className="avatars-stack mt-2">
                  <div className="avatar avatar-xs">
                    <img src={`${avatars}/2.jpg`} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={`${avatars}/3.jpg`} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={`${avatars}/4.jpg`} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={`${avatars}/5.jpg`} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={`${avatars}/6.jpg`} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={`${avatars}/7.jpg`} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={`${avatars}/8.jpg`} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                </div>
              </ListGroupItem>
